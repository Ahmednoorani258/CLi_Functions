...
async function TakeUserInput(name1, type1, question1, choices1) {
...
class CLI {
    ...
    async numToWords() {
        while (true) {
            ...
            console.log(chalk.yellow(`Enter a number between 0 and 1,000,000,000,000 (1 Trillion) \nand it will convert that number into words`));
            console.log("\t");
    ...
    async permutations() {
        while (true) {
            ...
            console.log("\t");
            console.log(chalk.yellowBright.underline("Instructions:"));
            console.log(chalk.yellow(`A permutation function generates all possible arrangements of a set of items. It is used to determine how many ways you can order a specific word .. check this by entering any word  below:.`));
            console.log("\t");
            const input = await inquirer.prompt([
                {
                    type: "input",
    ...
    async exitProgram() {
        ...
        console.log("\t");
        console.log(`${chalk.black.bgWhite("Github:")}  \t https://github.com/Ahmednoorani258 `);
        console.log(`${chalk.black.bgWhite("LinkedIn")} \t https://www.linkedin.com/in/mahmednorani/`);
        console.log("\t");
    ...
    async main() {
        while (true) {
            const ans = await TakeUserInput("input", "list", "Select operation", ["1. Convert Number to Word", "2. Permutation Checker", "3. Exit"]);
            console.log("\t");
            switch (ans.input) {
